...
class SoundManager:
    def __init__(self):
        ...
        self.load_sound("gobelin_detect", os.path.join(ROOT_DIR, "assets/audio/gobelin_detect.mp3"), volume=0.2)
        ...
        self.load_sound("boss_detect",     os.path.join(ROOT_DIR, "assets/audio/boss_detect.mp3"),     volume=0.5)
        self.load_sound("boss_projectile", os.path.join(ROOT_DIR, "assets/audio/boss_projectile.mp3"), volume=0.3)
        self.load_sound("boss_hit",        os.path.join(ROOT_DIR, "assets/audio/boss_hit.mp3"),        volume=0.4)
        self.load_sound("boss_regen",      os.path.join(ROOT_DIR, "assets/audio/boss_regen.mp3"),      volume=0.3)
        self.load_sound("boss_detect",     os.path.join(ROOT_DIR, "assets/audio/boss_detect.mp3"),     volume=0.5)
        self.load_sound("boss_projectile", os.path.join(ROOT_DIR, "assets/audio/boss_projectile.mp3"), volume=0.3)
        self.load_sound("boss_hit",        os.path.join(ROOT_DIR, "assets/audio/boss_hit.mp3"),        volume=0.4)
        self.load_sound("boss_regen",      os.path.join(ROOT_DIR, "assets/audio/boss_regen.mp3"),      volume=0.3)
        ...
        self._current_boucle = self.music_boucle_path  
        try:
    ...
    def start_music(self):
        ...
        try:
            ...
            pygame.mixer.music.load(self.music_intro_path)
            pygame.mixer.music.queue(self.music_boucle_path)   
            pygame.mixer.music.set_volume(self.music_base_volume * self.global_volume)
