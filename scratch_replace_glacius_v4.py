...
new_glacius = """class Glacius(BossBase):
    ...
    def _load_sprites(self):
        ...
        def load_seq(folder_name, prefix):
            ...
            if not os.path.exists(actual_dir):
                s = pygame.Surface((368, 192), pygame.SRCALPHA)
                return [s]
            ...
            for i in range(1, len(files) + 1):
                ...
                if os.path.exists(path):
                    try:
                        ...
                        cropped = pygame.transform.scale(cropped, (368, 192))
    ...
    def _update_visual(self, dt_ms):
        ...
        if self.attack_name == "laser_beam" and self.attack_state in (WINDUP, EXECUTING):
            import pygame
            pygame.draw.circle(base, (0, 200, 255, 100), (184, 96), 140, 15)
            pygame.draw.circle(base, (255, 255, 255, 150), (184, 96), 130, 5)
